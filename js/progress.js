const originDate = new Date("2025-12-05T00:00:00.000");
const countDownDate = new Date("2026-01-30T00:00:00.000");
...
const cTitle1Text = "BEGINNING DESCENT";
...
async function startCountDown() {
    ...
    let x = setInterval(async () => {
        ...
        if (remaining < 0) {
            ...
            aend.play();
            document.getElementById('cTitle1Text').innerHTML = 'APPROACHING MAXIMUM DEPTH';
            document.getElementById('cTitle2Text').innerHTML = 'CLOSING PORTHOLE SHIELDING';
